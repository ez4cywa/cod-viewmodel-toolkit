...
def _assert_loaded(path, plugin_name):
    ...
    if version != "3.4.1":
        raise RuntimeError("Expected version 3.4.1, got %s" % version)
...
def main():
    ...
    if chinese_core._zh_cn_entry_version != "3.4.1":
