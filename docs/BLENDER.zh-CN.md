...
3.4.3 提供 `cod-viewmodel-toolkit-3.4.3-blender-zh-CN.zip`；Blender 功能与 3.4.0
...
1. 下载 `cod-viewmodel-toolkit-3.4.3-blender-zh-CN.zip`（中文）或 `cod-viewmodel-toolkit-3.4.3-blender-en.zip`（英文）。
